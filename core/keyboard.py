...
class KeyboardManager(QObject):
    ...
    def start(self, hotkey: str, voice_hotkey: str, enable_live: bool, enable_layout_switch: bool = False) -> None:
    ...
    def update_settings(self, hotkey: str, voice_hotkey: str, enable_live: bool, enable_layout_switch: bool = False) -> None:
        """Update hotkey and live typing status dynamically."""
        self.start(hotkey, voice_hotkey, enable_live, enable_layout_switch)
